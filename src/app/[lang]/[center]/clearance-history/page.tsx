                          ...
                          <td className="p-2">
                            ...
                            {item?.buyer?.nickname ? (
                              ...
                              <div className="flex flex-row items-center gap-2 justify-center">
                                <div className="text-lg font-normal text-yellow-500">
                                  {item.buyer?.nickname}
                                </div>
                              ...
                              
                              {
                                ...
                                <div className="flex flex-row gap-2">
                                  ...
                                  <button
                                    ...
                                    className={`
                                      w-24 h-8
                                      flex flex-row gap-1 text-sm  px-2 py-1 rounded-md ${escrowing[index] || requestingPayment[index] || !requestPaymentCheck[index] ? 'bg-gray-500' : 'bg-green-500'}`}
                                    onClick={() => {
