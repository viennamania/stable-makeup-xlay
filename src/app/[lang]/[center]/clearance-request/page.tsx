          ...
          <div className="flex flex-col items-start justify-center gap-2">
            ...
            */}
            ...
            <div className='flex flex-row items-center space-x-4'>
              ...
              <div className="w-full flex flex-col xl:flex-row items-start justify-start gap-5 mt-4">
                ...
                <div className="flex flex-col gap-2 items-start">
                  ...
                  <div className="mt-2 w-full max-h-[300px] overflow-y-auto
                    border border-zinc-800 rounded-lg bg-zinc-900
                  ">
                    {allBuyer.length > 0 ? (
                ...
                <article
                  className={` w-full max-w-2xl
                      ...
                      border
                      ${buyerWalletAddress ? 'border-green-400' : 'border-zinc-700'}
                      `}>
                    <div className="
                      flex flex-col xl:flex-row gap-5 xl:gap-20 items-center ">
                        ...
                        <div className="flex flex-col gap-2 items-start">
                          ...
                          <p className="mt-4 text-xl font-bold 0">1 USDT = {
                            // currency format
                          ...
                          <div className=" flex flex-col items-center gap-2">
                            ...
                            <div className="flex flex-row items-center gap-2">
                              ...
                              />
                              <span className="text-2xl text-yellow-500 font-normal"
                                style={{ fontFamily: 'monospace' }}
                              >
                                {krwAmount === 0 ? '0' : Number(krwAmount).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                              </span>
                              <span className="text-xl 0 font-bold">
                                원  
                              </span>
                            ...
                            {/* 판매량 */}
                            <div className="flex flex-row items-center gap-2">
                              <span className="text-lg font-normal 0">
                                판매량(USDT)
                              </span>
                              {'='}
                              <div className="flex flex-row items-center gap-1">
                                <Image
                                  ...
                                  className="w-5 h-5"
                                />
                                <span className=" text-2xl text-green-400 font-normal"
                                  style={{ fontFamily: 'monospace' }}
                                >
                                {
                                  krwAmount === 0 ? '0' :
                          ...
                          {buyOrdering ? (
                            ...
                            <div className="flex flex-row items-center gap-2">
                              ...
                              <button
                                  ...
                                  className={`text-lg   px-4 py-2 rounded-md ${krwAmount === 0 || agreementPlaceOrder === false
                                    || !buyerNickname
                                  ...
                                  <div className="flex flex-row items-center gap-2">
                                    ...
                                    <button
                                      ...
                                      className={`
                                        ...
                                        flex flex-row
                                        items-center justify-center
                                        gap-1 text-sm  px-2 py-1 rounded-md ${cancellings[index] || !agreementForCancelTrade[index] ? 'bg-gray-500' : 'bg-red-500'}`}
                                  ...
                                  <div className="flex flex-row items-center gap-2">
                                    ...
                                    <button
                                      ...
                                      className={`
                                        ...
                                        flex flex-row 
                                        items-center justify-center
                                        gap-1 text-sm  px-2 py-1 rounded-md
                                ...
                                
                                {
                                  ...
                                  <div className="flex flex-row gap-2">
                                    ...
                                    <button
                                      ...
                                      className={`
                                        w-24 h-8
                                        flex flex-row gap-1 text-sm  px-2 py-1 rounded-md ${escrowing[index] || requestingPayment[index] || !requestPaymentCheck[index] ? 'bg-gray-500' : 'bg-green-600'}`}
                                      onClick={() => {
                                    ...
                                    <div className="flex flex-row gap-2">
                                      ...
                                      <button
                                        ...
                                        className={`
                                          ...
                                          flex flex-row
                                          items-center justify-center
                                          gap-1 text-sm  px-2 py-1 rounded-md ${confirmingPayment[index] || !confirmPaymentCheck[index] ? 'bg-gray-500' : 'bg-green-600'}`}
                              ...
                              item.status === 'accepted' && (
                                <div className="flex flex-row gap-1">
                                  ...
                                  <button
                                    ...
                                    className={`flex flex-row gap-1 text-sm  px-2 py-1 rounded-md ${escrowing[index] || requestingPayment[index] || !requestPaymentCheck[index] ? 'bg-gray-500' : 'bg-green-600'}`}
                                    onClick={() => {
            ...
            <div className="mt-4 flex flex-row items-center justify-center gap-4">
              ...
              <button
                ...
                className={`text-sm  px-4 py-2 rounded-md ${Number(page) <= 1 ? 'bg-gray-500' : 'bg-green-600 hover:bg-green-600'}`}
                onClick={() => {
              ...
              <button
                ...
                className={`text-sm  px-4 py-2 rounded-md ${Number(page) >= Math.ceil(Number(totalCount) / Number(limit)) ? 'bg-gray-500' : 'bg-green-600 hover:bg-green-600'}`}
                onClick={() => {
