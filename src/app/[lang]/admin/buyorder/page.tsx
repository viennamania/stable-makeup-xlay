    ...
    return (
      <main className="p-4 pb-10 min-h-[100vh] flex items-start justify-center container max-w-screen-2xl mx-auto">
        <div className="py-0 w-full flex flex-col items-center justify-center gap-4">
          ...
          <div className="text-lg ">회원 정보를 불러오는 중</div>
        </div>
      </main>
    );
  }
      ...
      <div className="py-0 w-full">
                ...
                <div key={index}
                  ...
                  <div className="flex flex-row items-center gap-4">
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-semibold text-[#3167b4]">
                        {seller.nickname}
                      </span>
                      <button
                                    ...
                                    >
                                      <div className="w-full flex flex-row gap-2 items-center justify-center">
                                        ...
                                        <span className="text-sm text-gray-700 font-semibold">
                                          {confirmingPayment[index] ? '처리 중...' : '입금확인 처리하기'}
                                        </span>
                                      </div>
        ...
        <div className="mt-4 flex flex-row items-center justify-center gap-4">
          ...
          <button
            ...
            className={`text-sm px-4 py-2 rounded-md ${Number(pageValue) >= Math.ceil(Number(buyOrderStats.totalCount) / Number(limitValue)) ? 'bg-gray-500' : 'bg-green-500 hover:bg-green-600'}`}
            onClick={() => {
